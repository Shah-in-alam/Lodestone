...
/// Returns list of (from, to) for every stone that was pulled.
List<((int, int), (int, int))> resolvePulls(
    Board board, int row, int col, Player placer) {
...
/// Returns (enemyCapturedPositions, selfCapturedPositions).
(List<(int, int)>, List<(int, int)>) resolveCaptures(
    Board board, Player activePl) {
